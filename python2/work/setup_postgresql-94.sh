...
mkdir /var/lib/pgsql-9
echo '/spare/pgsql-9    /var/lib/pgsql-9 defaults,none   bind            0 0' >> /etc/fstab
mount /var/lib/pgsql-9
...
>/var/lib/pgsql-9/9.4/data/pg_hba.conf;

cat <<EOF > /var/lib/pgsql-9/9.4/data/pg_hba.conf
...
then
	...
	if [ -d "/var/lib/pgsql9/" -o -d "/spare/pgsql-9/" ]
	then
